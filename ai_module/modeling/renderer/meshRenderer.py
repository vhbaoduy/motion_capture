...
from modeling.renderer.shaders.framework import *

from modeling.renderer.glRenderer import glRenderer
...
class meshRenderer(glRenderer):
    ...
    def __init__(self, width=1600, height=1200, name='GL Renderer',
        ...
        self.program_files ={}
        self.program_files['color'] = ['modeling/renderer/shaders/simple140.fs', 'modeling/renderer/shaders/simple140.vs']
        self.program_files['normal'] = ['modeling/renderer/shaders/normal140.fs', 'modeling/renderer/shaders/normal140.vs']
        self.program_files['geo'] = ['modeling/renderer/shaders/colorgeo140.fs', 'modeling/renderer/shaders/colorgeo140.vs']
