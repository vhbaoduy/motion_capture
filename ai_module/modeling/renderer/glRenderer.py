...
from modeling.renderer.shaders.framework import createProgram, loadShader

from modeling.renderer.render_utils import ComputeNormal
...
class glRenderer:
    ...
    def __init__(self, width=640, height=480, name='GL Renderer',
                 program_files=['modeling/renderer/shaders/simple140.fs', 'modeling/renderer/shaders/simple140.vs'], color_size=1, ms_rate=1):
        self.width = width
        self.height = height
        self.name = name
